            ...
            <InspectorControls>
                ...
                >
                    ...
                    <TextControl
                        ...
                        onChange={ ( value ) =>
                            setAttributes( { confirmPassword: value } )
                        }
                    />
                    <TextControl
                        label={ __(
                        ...
                        onChange={ ( value ) =>
                            setAttributes( {
                                confirmPasswordPlaceholder: value,
                            } )
                        }
                    />
                    <TextControl
                        ...
                        onChange={ ( value ) =>
                            setAttributes( { registerButtonLabel: value } )
                        }
                    />
                </PanelBody>
            </InspectorControls>
            <div { ...useBlockProps() }>
                ...
                >
                    ...
                    <p className="boosted-front-end-password">
                        ...
                        />
                        <input
                            className="boosted-front-end-password-confirm-field"
                            type="email"
                            id="user_pass"
                            name="user_pass"
                            required
